...
**Шрифты проверены на казахский алфавит.** Обычная история: берёшь
красивый дисплейный шрифт, а он не знает букв ә, ғ, қ, ң, ө, ұ, ү — и слово
«Соғыс» на главной странице разваливается на два шрифта. Я прогнал кандидатов
канвасом, сравнивая ширину глиф с фолбэком, и выяснил, что дыры есть и в
Unbounded, и в Manrope, и в JetBrains Mono. Весь текст, который вводят
пользователи, теперь набирается Onest и IBM Plex Mono с полным покрытием;
Unbounded остался только в заголовках и подстрахован Onest. Мелочь, которую
на казахстанском продукте замечают сразу.
